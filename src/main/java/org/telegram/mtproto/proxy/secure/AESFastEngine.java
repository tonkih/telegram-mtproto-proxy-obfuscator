...
import static org.telegram.mtproto.proxy.util.Utils.intToLittleEndian;
import static org.telegram.mtproto.proxy.util.Utils.littleEndianToInt;
...
public class AESFastEngine {
    ...
    private int[][] generateWorkingKey(byte[] key, boolean forEncryption) {
        ...
        switch (KC) {
            ...
            case 6: {
                ...
                int t3 = littleEndianToInt(key, 12);
                W[0][3] = t3;
                int t4 = littleEndianToInt(key, 16);
                W[1][0] = t4;
                int t5 = littleEndianToInt(key, 20);
                W[1][1] = t5;
            ...
            case 8: {
                ...
                int t5 = littleEndianToInt(key, 20);
                W[1][1] = t5;
                int t6 = littleEndianToInt(key, 24);
                W[1][2] = t6;
                int t7 = littleEndianToInt(key, 28);
                W[1][3] = t7;
    ...
    private void unpackBlock(byte[] bytes, int off) {
        this.C0 = littleEndianToInt(bytes, off);
        this.C1 = littleEndianToInt(bytes, off + 4);
        this.C2 = littleEndianToInt(bytes, off + 8);
        this.C3 = littleEndianToInt(bytes, off + 12);
    }

    private void packBlock(byte[] bytes, int off) {
        intToLittleEndian(this.C0, bytes, off);
        intToLittleEndian(this.C1, bytes, off + 4);
        intToLittleEndian(this.C2, bytes, off + 8);
        intToLittleEndian(this.C3, bytes, off + 12);
    }
